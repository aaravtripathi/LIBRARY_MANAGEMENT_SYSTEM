...
output_pdf = os.path.join(os.path.abspath(os.path.dirname(__file__)), "MPOnline_Enterprise_LMS_IEEE_Paper.pdf")
assets_dir = os.path.join(os.path.abspath(os.path.dirname(__file__)), "report_assets")

print(f"Starting compilation of comprehensive IEEE Transaction Format Technical Report: {output_pdf}")
...
def build_pdf():
    ...
    story.append(Paragraph("<b>A. Overview of the MPOnline Internship Program</b>", h2))
    ...
    story.append(Paragraph("<b>B. Institutional Problem Statement & Objectives</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Project Scope & Deliverables</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. System Architecture Executive Summary</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>A. Comprehensive Functional Requirements Matrix</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Strict Non-Functional Requirements (NFR)</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Detailed Use Case Narratives</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Technical, Economic & Operational Feasibility Matrix</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>A. Historical Paradigm Shift: Client-Server to Cloud Computing</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. NIST Essential Characteristics & Cloud Abstraction Models</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Cloud Deployment Models in Institutional Ecosystems</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. AWS Simple Storage Service (S3) Static Hosting Pipeline</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>A. SPA Deconstruction: Transforming to Semantic Multi-Page Architecture</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Structural Analysis of Core HTML5 Views</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. CSS3 Design System Tokenization & Dark Mode Glassmorphism</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Responsive Flexbox/Grid Breakpoint Geometry</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>E. Client-Side DOM Interactivity & Local Storage Persistence</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("V. DATABASE MODELING & TPH DATA ARCHITECTURE", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. Enterprise Relational Database Modeling & Inheritance</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Publications Data Dictionary & DDL Seeding Architecture</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. ASP.NET Core Identity Relational Schema Breakdown</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Database Normalization & Indexing Strategies</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>E. Quantitative Evaluation: Table-Per-Hierarchy vs. Multi-Table JOINs</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("VI. ASP.NET CORE 8 BACKEND & SECURITY ARCHITECTURE", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. ASP.NET Core Dependency Injection & HTTP Pipeline Registration</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Core Identity Service Managers & Role-Based Access Control</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Dynamic Search & Windowed SQL Server Pagination</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Asynchronous Request Processing & Thread Pool Non-Starvation</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>E. Full-Stack MVC Controller Suite & REST API Bridge Architecture</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>F. Role-Based Access Control Security Boundaries Matrix</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("VII. QUALITY ASSURANCE & XUNIT TESTING SUITE", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. Comprehensive QA Testing Methodologies</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. xUnit & FluentAssertions Unit Testing Implementation</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Master QA Test Execution Matrix</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>A. Software as an Evolutionary Entity (Lehman's Laws)</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. The Four Taxonomies of Software Maintenance</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Relative Cost of Bug Fixes across SDLC Phases</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Comprehensive Taxonomy of Software Bug Types</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>E. Severity vs. Priority & Bug Resolution SLAs</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>F. Operationalized Maintenance Automation: Compounding Penalty Assessment</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("IX. SYSTEM QUANTIFICATIONS & PERFORMANCE TUNING", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. Advanced C# & Web Application Performance Tuning</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Quantitative Benchmarking: Memory Allocation vs. Throughput</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. SQL Server Windowed Pagination Performance Quantifications</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>D. Concurrency Stress Benchmarking: Asynchronous vs. Synchronous Threads</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>E. Comprehensive Latency Distribution: Browser DOM Storage vs. Cloud REST API</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("X. CONCLUSION, FUTURE SCOPE & REFERENCES", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. Summary of Engineering Achievements</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. Strategic Roadmap & Future Scope</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>C. Academic & Industrial References</b>", h2))
    ...
    # ==========================================
    story.append(Paragraph("APPENDIX A: CODEBASE AUDIT & STRUCTURAL MAPPINGS", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. Master Codebase Audit Directory</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. CSS Design Tokenization Hierarchy & Responsive Geometry</b>", h2))
    story.append(Paragraph(
    ...
    # ==========================================
    story.append(Paragraph("APPENDIX B: DEVOPS DEPLOYMENT & MAINTENANCE RUNBOOKS", h1))
    story.append(HRFlowable(width="100%", thickness=1.5, color=c_darkblue, spaceBefore=2, spaceAfter=14))
    
    story.append(Paragraph("<b>A. AWS S3 & CloudFront Content Delivery Deployment Checklist</b>", h2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>B. SQL Server Indexing & Performance Maintenance Runbook</b>", h2))
    story.append(Paragraph(
