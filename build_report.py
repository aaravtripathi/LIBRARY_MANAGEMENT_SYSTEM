...
output_pdf = os.path.join(os.path.abspath(os.path.dirname(__file__)), "MPOnline_Library_Management_System_Internship_Report.pdf")
assets_dir = os.path.join(os.path.abspath(os.path.dirname(__file__)), "report_assets")

print(f"Starting compilation of comprehensive ~50-page PDF report: {output_pdf}")
