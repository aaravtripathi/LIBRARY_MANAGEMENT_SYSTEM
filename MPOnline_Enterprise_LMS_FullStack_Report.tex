...
\usepackage{setspace}
\usepackage{helvet}
\renewcommand{\familydefault}{\sfdefault} % Standard professional sans-serif academic engineering style
\setstretch{1.35}
...
\hypersetup{
    ...
    urlcolor=navyblue,
    citecolor=navyblue,
    pdftitle={MPOnline Advanced Software Engineering Internship Report - Library Management System},
    pdfauthor={Aarav Tripathi}
}

% Custom Colors
\definecolor{navyblue}{HTML}{111720}
\definecolor{sectionblue}{HTML}{1B4F72}
\definecolor{accentgold}{HTML}{C67B20}
\definecolor{tablebg}{HTML}{1F2630}
\definecolor{tablealt}{HTML}{F8F9FC}
\definecolor{calloutbg}{HTML}{F8F9FB}
\definecolor{calloutborder}{HTML}{CBD5E1}
\definecolor{darkgray}{HTML}{555A64}

% Header & Footer Customization (FancyHdr)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont \color{darkgray} MPOnline Advanced Software Engineering Internship}
\fancyhead[R]{\fontsize{9}{11}\selectfont \color{darkgray} Technical Report: LMS}
\fancyfoot[L]{\fontsize{9}{11}\selectfont \color{darkgray} \copyright\ 2026 MPOnline Internship $\cdot$ Confidential}
\fancyfoot[R]{\fontsize{9}{11}\selectfont \color{darkgray} Page \thepage}
\renewcommand{\headrulewidth}{0.6pt}
\renewcommand{\headrule}{\hbox to\headwidth{\color{calloutborder}\leaders\hrule height \headrulewidth\hfill}}
\renewcommand{\footrulewidth}{0.6pt}
\renewcommand{\footrule}{\hbox to\headwidth{\color{calloutborder}\leaders\hrule height \footrulewidth\hfill}}

% Section formatting
\titleformat{\chapter}[block]{\huge\bfseries\color{navyblue}}{}{0pt}{\huge}[\vspace{0.5ex}\textcolor{navyblue}{\titlerule[1.5pt]}]
...
% Custom Callout Box Environment
...
\begin{center}
    \vspace*{30pt}
    {\large \textbf{\color{darkgray} ADVANCED SOFTWARE ENGINEERING \& DEVELOPMENT INTERNSHIP}}\\[20pt]
    
    {\fontsize{28}{34}\selectfont \textbf{\color{navyblue} Library Management System (LMS)}}\\[18pt]
    
    {\Large \color{accentgold} Architectural Evolution, Multi-Page Web Implementation, ASP.NET Core Identity RBAC \& System Quantifications}\\[25pt]
    
    {\color{accentgold}\rule{0.6\textwidth}{3pt}}\\[50pt]
    
    \vfill
    
    {\renewcommand{\arraystretch}{1.4}%
    \begin{tabular}{>{\raggedleft\arraybackslash}p{5.5cm} >{\raggedright\arraybackslash}p{9.0cm}}
        \textbf{Name:} & Aarav Tripathi \\
        \textbf{Application Number:} & IN26012764 \\
        \textbf{Organization:} & MPOnline Limited \\
        \textbf{Subject:} & Advanced Software Engineering And Development Internship [11A] \\
    \end{tabular}}
    \vspace*{30pt}
\end{center}
...
% ==========================================
\chapter{Executive Summary \& Project Scope}

\section{Overview of the MPOnline Internship Program}
...
\section{Institutional Problem Statement \& Objectives}
...
\section{System Architecture Executive Summary}
...
% ==========================================
\chapter{System Requirements \& Feasibility Analysis}

\section{Comprehensive Functional Requirements Matrix}
...
\section{Strict Non-Functional Requirements (NFR)}
...
\section{Technical, Economic \& Operational Feasibility Matrix}
...
\section{Institutional Risk Analysis \& Mitigation Strategies}
...
% ==========================================
\chapter{Architectural Design \& Cloud Deployment Evolution}

\section{Historical Paradigm Shift: Client-Server to Cloud Computing}
...
\section{NIST Essential Characteristics \& Cloud Abstraction Models}
...
\section{Cloud Deployment Models in Institutional Ecosystems}
...
\section{AWS Simple Storage Service (S3) Static Hosting Pipeline}
...
\section{Cloud Security, CORS Policy \& Content Distribution}
...
% ==========================================
\chapter{Frontend Multi-Page Web Implementation \& Refactoring}

\section{SPA Deconstruction: Transforming to Semantic Multi-Page Architecture}
...
\section{Structural Analysis of Core HTML5 Views}
...
\section{CSS3 Design System Tokenization \& Dark Mode Glassmorphism}
...
\section{Responsive Flexbox/Grid Breakpoint Geometry}
...
\section{Client-Side DOM Interactivity \& Local Storage Persistence}
...
% ==========================================
\chapter{Database Modeling \& Data Architecture}

\section{Enterprise Relational Database Modeling \& Inheritance}
...
\section{Publications Data Dictionary \& DDL Seeding Architecture}
...
\section{ASP.NET Core Identity Relational Schema Breakdown}
...
\section{Database Normalization \& Indexing Strategies}
...
\section{Quantitative Evaluation: Table-Per-Hierarchy vs. Multi-Table JOINs}
...
% ==========================================
\chapter{Backend Application \& Security Integration Roadmap}

\section{ASP.NET Core Dependency Injection \& HTTP Pipeline Registration}
...
\section{Core Identity Service Managers \& Role-Based Access Control}
...
\section{Dynamic Search \& Windowed SQL Server Pagination}
...
\section{Asynchronous Request Processing \& Thread Pool Non-Starvation}
...
\section{Full-Stack MVC Controller Suite \& REST API Bridge Architecture}
...
\section{Role-Based Access Control Security Boundaries Matrix}
...
% ==========================================
\chapter{Quality Assurance \& Automated Testing Suite}

\section{Comprehensive QA Testing Methodologies}
...
\section{xUnit \& FluentAssertions Unit Testing Implementation}
...
\section{Master QA Test Execution Matrix}
...
\section{User Acceptance Testing (UAT) \& CI/CD Validation}
...
% ==========================================
\chapter{Software Maintenance, Bug Triage \& Resolution SLAs}

\section{Software as an Evolutionary Entity (Lehman's Laws)}
...
\section{The Four Taxonomies of Software Maintenance}
...
\section{Relative Cost of Bug Fixes across SDLC Phases}
...
\section{Comprehensive Taxonomy of Software Bug Types}
...
\section{Severity vs. Priority \& Bug Resolution SLAs}
...
\section{Operationalized Maintenance Automation: Compounding Penalty Assessment}
...
% ==========================================
\chapter{System Quantifications, Metrics \& Performance Tuning}

\section{Advanced C\# \& Web Application Performance Tuning}
...
\section{Quantitative Benchmarking: Memory Allocation vs. Throughput}
...
\section{SQL Server Windowed Pagination Performance Quantifications}
...
\section{Concurrency Stress Benchmarking: Asynchronous vs. Synchronous Threads}
...
\section{Comprehensive Latency Distribution: Browser DOM Storage vs. Cloud REST API}
...
% ==========================================
\chapter{Conclusion, Future Scope \& References}

\section{Summary of Engineering Achievements}
...
\section{Strategic Roadmap \& Future Scope}
...
\section{Academic \& Industrial References}
\begin{enumerate}[leftmargin=1.5em]
...
% ==========================================
\chapter{Appendix A: Code Base Audit \& Structural Mappings}

\section{Master Codebase Audit Directory}
...
\section{CSS Design Tokenization Hierarchy \& Responsive Geometry}
...
\section{JavaScript Event Delegation \& Storage Synchronization Engine}
...
% ==========================================
\chapter{Appendix B: Master DevOps \& Deployment Runbooks}

\section{AWS S3 \& CloudFront Content Delivery Deployment Checklist}
...
\section{SQL Server Indexing \& Performance Maintenance Runbook}
